...
class HeadsetPhoneState {
    private static final String TAG = "LZLB_HeadsetPhoneState";
    ...
    void listenForPhoneState(boolean start) {
		Log.e(TAG,"listenForPhoneState start:"+start);
        mSlcReady = start;
    ...
    private void startListenForPhoneState() {
    	Log.e(TAG,"startListenForPhoneState ");
    ...
    private void stopListenForPhoneState() {
    	Log.e(TAG,"stopListenForPhoneState ");
    ...
    void setBatteryCharge(int batteryLevel) {
    	Log.e(TAG,"setBatteryCharge batteryLevel:"+batteryLevel);
    ...
    {
    	Log.e(TAG,"sendDeviceStateChanged");
    ...
    private PhoneStateListener getPhoneStateListener(int subId) {
        ...
        PhoneStateListener mPhoneStateListener = new PhoneStateListener(subId) {
			...
			private static final String TAG="LZLB_PhoneStateListener";
            @Override
            ...
            public void onSignalStrengthsChanged(SignalStrength signalStrength) {
				Log.e(TAG,"onSignalStrengthsChanged");
