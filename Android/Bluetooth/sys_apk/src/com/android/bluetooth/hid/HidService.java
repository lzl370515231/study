...
public class HidService extends ProfileService {
    ...
    public static final String TAG = "LZLB_HidService";
    ...
    private static class BluetoothInputDeviceBinder extends IBluetoothInputDevice.Stub implements IProfileServiceBinder{
		...
		private static final String TAG ="LZLB_BluetoothInputDeviceBinder";
    ...
    Log.e(TAG,"onConnectStateChanged");
    ...
    Log.e(TAG,"broadcastProtocolMode");
    ...
    Log.e(TAG,"broadcastVirtualUnplugStatus");
    ...
    Log.e(TAG,"convertHalState halState:"+halState);
        switch (halState) {
