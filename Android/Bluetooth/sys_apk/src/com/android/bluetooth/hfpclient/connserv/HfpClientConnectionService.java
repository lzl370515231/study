...
public class HfpClientConnectionService extends ConnectionService {
    private static final String TAG = "LZLB_HfpClientConnService";
    ...
    public Connection onCreateIncomingConnection(
        ...
        Log.e(TAG, "onCreateIncomingConnection " + connectionManagerAccount + " req: " + request);
    ...
    public Connection onCreateOutgoingConnection(
            PhoneAccountHandle connectionManagerAccount,
            ConnectionRequest request) {
        Log.e(TAG, "onCreateOutgoingConnection " + connectionManagerAccount);
        if (connectionManagerAccount != null &&
                !getHandle().equals(connectionManagerAccount)) {
            Log.w(TAG, "HfpClient does not support having a connection manager");
            return null;
    ...
    public Connection onCreateUnknownConnection(
            PhoneAccountHandle connectionManagerAccount,
            ConnectionRequest request) {
        Log.e(TAG, "onCreateUnknownConnection " + connectionManagerAccount);
        if (connectionManagerAccount != null &&
                !getHandle().equals(connectionManagerAccount)) {
            Log.w(TAG, "HfpClient does not support having a connection manager");
            return null;
    ...
    public void onConference(Connection connection1, Connection connection2) {
        Log.e(TAG, "onConference " + connection1 + " " + connection2);
        if (mConference == null) {
    ...
    Log.e(TAG, "updateConferenceableConnections ");
    ...
    private HfpClientConnection buildConnection(
        ...
        Log.e(TAG, "Creating connection on " + device + " for " + call + "/" + number);
        HfpClientConnection connection =
