...
class AdapterProperties {
    ...
    private static final String TAG = "LZLB_BluetoothAdapterProperties";
    ...
    private boolean validateProfileConnectionState(int state) {
    	Log.e(TAG,"validateProfileConnectionState state:"+state);
    ...
    private int convertToAdapterState(int state) {
    	Log.e(TAG,"convertToAdapterState state:"+state);
        switch (state) {
    ...
    Log.e(TAG,"updateCountersAndCheckForConnectionStateChange prevState:"+prevState+"--state:"+state);
        switch (prevState) {
            case BluetoothProfile.STATE_CONNECTING:
                mProfilesConnecting--;
                break;
    ...
    private void updateProfileConnectionState(int profile, int newState, int oldState) {
    	Log.e(TAG,"updateProfileConnectionState");
    ...
    void updateFeatureSupport(byte[] val) {
    	Log.e(TAG,"updateFeatureSupport");
