...
final class RemoteDevices {
    ...
    private static final String TAG = "LZLB_RemoteDevices";
    ...
    class DeviceProperties {
		...
		private static final String TAG ="LZLB_DeviceProperties";
        ...
        Log.e(TAG,"setAlias mAlias:"+mAlias);
            synchronized (mObject) {
                this.mAlias = mAlias;
