...
public class SdpManager {
    ...
    private static final String TAG="LZLB_SdpManager";
    ...
    private class SdpSearchInstance {
		...
		private static final String TAG ="LZLB_SdpSearchInstance";
    ...
    class SdpSearchTracker {
		...
		private static final String TAG ="LZLB_SdpSearchTracker";
    ...
    void sdpMasRecordFoundCallback(int status, byte[] address, byte[] uuid,
            ...
            String serviceName,
            boolean moreResults) {
		Log.e(TAG,"sdpMasRecordFoundCallback");
    ...
    void sdpMnsRecordFoundCallback(int status, byte[] address, byte[] uuid,
            ...
            String serviceName,
            boolean moreResults) {
            Log.e(TAG,"sdpMnsRecordFoundCallback");
        synchronized(mTrackerLock) {
    ...
    void sdpPseRecordFoundCallback(int status, byte[] address, byte[] uuid,
                                        ...
                                        String serviceName,
                                        boolean moreResults) {
                                         Log.e(TAG,"sdpPseRecordFoundCallback");
        synchronized(mTrackerLock) {
            SdpSearchInstance inst = sSdpSearchTracker.getSearchInstance(address, uuid);
    ...
    void sdpOppOpsRecordFoundCallback(int status, byte[] address, byte[] uuid,
            ...
            byte[] formatsList,
            boolean moreResults) {
											Log.e(TAG,"sdpOppOpsRecordFoundCallback");
    ...
    void sdpSapsRecordFoundCallback(int status, byte[] address, byte[] uuid,
            ...
            String serviceName,
            boolean moreResults) {
				Log.e(TAG,"sdpSapsRecordFoundCallback");
    ...
    void sdpRecordFoundCallback(int status, byte[] address, byte[] uuid,
            ...
            Log.e(TAG,"sdpRecordFoundCallback");
        synchronized(mTrackerLock) {
