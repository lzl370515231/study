...
public class BluetoothMapSmsPdu {
    ...
    private static final String TAG = "LZLB_BluetoothMapSmsPdu";
    ...
    public static class SmsPdu {
		...
		private static final String TAG ="LZLB_SmsPdu";
        ...
        private int cdmaGetParameterOffset(byte parameterId) {
        	Log.e(TAG,"cdmaGetParameterOffset");
        ...
        private int cdmaGetSubParameterOffset(byte subParameterId) {
				Log.e(TAG,"cdmaGetSubParameterOffset");
            ByteArrayInputStream pdu = new ByteArrayInputStream(mData);
            int offset = 0;
            boolean found = false;
        ...
        public void cdmaChangeToDeliverPdu(long date){
        	Log.e(TAG,"cdmaChangeToDeliverPdu date:"+date);
            /* Things to change:
        ...
        private int gsmSubmitGetTpPidOffset() {
				Log.e(TAG,"gsmSubmitGetTpPidOffset ");
        ...
        public void gsmDecodeUserDataHeader() {
        	Log.e(TAG,"gsmDecodeUserDataHeader ");
            ByteArrayInputStream pdu = new ByteArrayInputStream(mData);
...
/*        private void gsmSubmitExtractUserData() {
        ...
        {
        	Log.e(TAG,"gsmChangeToDeliverPdu ");
        ...
        public String getEncodingString(){
        	Log.e(TAG,"getEncodingString mEncoding:"+mEncoding);
    ...
    private static byte[] gsmStripOffScAddress(byte[] data) {
    	Log.e(TAG,"gsmStripOffScAddress");
