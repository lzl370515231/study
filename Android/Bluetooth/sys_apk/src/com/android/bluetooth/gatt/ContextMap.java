...
/*package*/ class ContextMap<T> {
    private static final String TAG = "LZLB_ContextMap";
    ...
    class App {
		...
		private static final String TAG="LZLB_APP";
    ...
    AppScanStats getAppScanStatsById(int id) {
    	Log.e(TAG,"getAppScanStatsById id"+id);
        App temp = getById(id);
        if (temp != null) {
    ...
    AppScanStats getAppScanStatsByName(String name) {
    	Log.e(TAG,"getAppScanStatsByName name"+name);
    ...
    App getByConnId(int connId) {
    	Log.e(TAG,"getByConnId connId:"+connId);
    ...
    Integer connIdByAddress(int id, String address) {
    	Log.e(TAG,"connIdByAddress id:"+id+"---address:"+address);
        App entry = getById(id);
    ...
    String addressByConnId(int connId) {
    	Log.e(TAG,"addressByConnId connId:"+connId);
        Iterator<Connection> i = mConnections.iterator();
        while (i.hasNext()) {
            Connection connection = i.next();
    ...
    List<Connection> getConnectionByApp(int appId) {
    	Log.e(TAG,"getConnectionByApp appId:"+appId);
