...
/* package */class ScanFilterQueue {
	...
	private static final String TAG ="LZLB_ScanFilterQueue";
    ...
    void addManufacturerData(int company, byte[] data) {
    	Log.e(TAG,"addManufacturerData 2");
        Entry entry = new Entry();
