...
class HandleMap {
    ...
    private static final String TAG = "LZLB_HandleMap";
    ...
    Log.e(TAG,"getCharacteristicHandle");
        for(Entry entry : mEntries) {
