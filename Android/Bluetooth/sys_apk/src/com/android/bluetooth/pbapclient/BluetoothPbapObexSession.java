...
final class BluetoothPbapObexSession {
    ...
    private static final String TAG = "LZLB_BluetoothPbapObexSession";
    ...
    public boolean schedule(BluetoothPbapRequest request) {
        if (DBG) {
            Log.e(TAG, "schedule() called with: " + request);
        }
    ...
    public boolean setAuthReply(String key) {
        Log.e(TAG, "setAuthReply key=" + key);
    ...
    private static class ObexClientHandler extends Handler {
		...
		private static final String TAG ="LZLB_ObexClientHandler";
