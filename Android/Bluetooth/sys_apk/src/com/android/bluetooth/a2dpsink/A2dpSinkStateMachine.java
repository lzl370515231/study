...
final class A2dpSinkStateMachine extends StateMachine {
	...
	private static final String TAG ="LZLB_A2dpSinkStateMachine";
    ...
    private A2dpSinkStateMachine(A2dpSinkService svc, Context context) {
		...
		Log.e(TAG,"A2dpSinkStateMachine");
        mService = svc;
        mContext = context;
    ...
    private class Disconnected extends State {
        ...
        Log.e(TAG, "processMessage message:" + message.what);
    ...
    private class Connected extends State {
        ...
        Log.e(TAG,"processAudioStateEvent state:"+state);
            if (!mCurrentDevice.equals(device)) {
    ...
    Log.e(TAG,"processAudioConfigEvent");
    ...
    private void broadcastConnectionState(BluetoothDevice device, int newState, int prevState) {
		Log.e(TAG,"broadcastConnectionState");
       int delay = 0;
...
//FIXME        intent.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
    ...
    Log.e(TAG,"broadcastAudioConfig");
...
//FIXME        intent.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
    ...
    Log.e(TAG,"onAudioConfigChanged");
    ...
    private class StackEvent {
		...
		private static final String TAG ="LZLB_StackEvent";
    ...
    private class IntentBroadcastHandler extends Handler {
		private static final String TAG ="LZLB_IntentBroadcastHandler";
