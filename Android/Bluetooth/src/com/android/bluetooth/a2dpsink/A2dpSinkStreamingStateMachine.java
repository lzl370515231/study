...
final class A2dpSinkStreamingStateMachine extends StateMachine {
    ...
    private static final String TAG = "LZLB_A2dpSinkStreamingStateMachine";
    ...
    private A2dpSinkStreamingStateMachine(A2dpSinkStateMachine a2dpSinkSm, Context context) {
		...
		Log.e(TAG,"A2dpSinkStreamingStateMachine");
    ...
    Log.e(TAG,"startFluorideStreaming");
    ...
    private class SRC_F_ACT_F extends State {
		...
		private static final String TAG ="LZLB_SRC_F_ACT_F";
        @Override
        public void enter() {
        	Log.e(TAG,"enter");
            if (DBG) {
    ...
    private class SRC_F_ACT_T extends State {
		...
		private static final String TAG ="LZLB_SRC_F_ACT_T";
    ...
    private class SRC_T_ACT_F extends State {
		...
		private static final String TAG ="LZLB_SRC_T_ACT_F";
        @Override
        public void enter() {
        	Log.e(TAG,"enter");
            if (DBG) {
    ...
    private class SRC_T_ACT_T extends State {
		...
		private static final String TAG ="LZLB_SRC_T_ACT_T";
        @Override
        public void enter() {
        	Log.e(TAG,"enter");
            if (DBG) {
