...
public class HealthService extends ProfileService {
    ...
    private static final String TAG="LZLB_HealthService";
    ...
    private final class HealthServiceMessageHandler extends Handler {
    	private static final String TAG ="LZLB_HealthServiceMessageHandler";
        ...
        public void handleMessage(Message msg) {
            if (DBG) Log.e(TAG,"HealthService Handler msg: " + msg.what);
            switch (msg.what) {
...
//Handler for DeathReceipient
    private static class BluetoothHealthDeathRecipient implements IBinder.DeathRecipient{
		...
		private static final String TAG ="LZLB_BluetoothHealthDeathRecipient";
    ...
    private static class BluetoothHealthBinder extends IBluetoothHealth.Stub implements IProfileServiceBinder {
        private HealthService mService;
		private static final String TAG ="LZLB_BluetoothHealthBinder";
        ...
        public boolean registerAppConfiguration(BluetoothHealthAppConfiguration config,
                                                ...
                                                Log.e(TAG,"registerAppConfiguration");
        ...
        Log.e(TAG,"unregisterAppConfiguration");
            HealthService service = getService();
            if (service == null) return false;
        ...
        public boolean connectChannelToSource(BluetoothDevice device,
                                              ...
                                              Log.e(TAG,"connectChannelToSource");
            HealthService service = getService();
            if (service == null) return false;
        ...
        public boolean connectChannelToSink(BluetoothDevice device,
                           ...
                           Log.e(TAG,"connectChannelToSink");
            HealthService service = getService();
            if (service == null) return false;
        ...
        Log.e(TAG,"getHealthDeviceConnectionState");
            HealthService service = getService();
        ...
        Log.e(TAG,"getConnectedHealthDevices");
            HealthService service = getService();
        ...
        Log.e(TAG,"getHealthDevicesMatchingConnectionStates");
            HealthService service = getService();
            if (service == null) return new ArrayList<BluetoothDevice> (0);
    ...
    Log.e(TAG,"onAppRegistrationState");
    ...
    private void onChannelStateChanged(int appId, byte[] addr, int cfgIndex,
                                       ...
                                       Log.e(TAG,"onChannelStateChanged");
    ...
    private String getStringChannelType(int type) {
    	Log.e(TAG,"getStringChannelType");
    ...
    Log.e(TAG,"findAppConfigByAppId appId:"+appId);
    ...
    private int convertHalChannelState(int halChannelState) {
    	Log.e(TAG,"convertHalChannelState");
    ...
    private void callHealthChannelCallback(BluetoothHealthAppConfiguration config,
            ...
            Log.e(TAG,"callHealthChannelCallback");
    ...
    Log.e(TAG,"broadcastHealthDeviceStateChange");
    ...
    Log.e(TAG,"convertState state:"+state);
        switch (state) {
    ...
    Log.e(TAG,"convertRoleToHal role:"+role);
    ...
    Log.e(TAG,"convertChannelTypeToHal channelType:"+channelType);
    ...
    private HealthChannel findChannelById(int id) {
    	Log.e(TAG,"findChannelById id:"+id);
        for (HealthChannel chan : mHealthChannels) {
    ...
    Log.e(TAG,"lookupHealthDevicesMatchingStates ");
    ...
    private static class AppInfo {
        ...
        private int mAppId;
		private static final String TAG="LZLB_AppInfo";
    ...
    private class HealthChannel {
		...
		private static final String TAG="LZL_HealthChannel";
