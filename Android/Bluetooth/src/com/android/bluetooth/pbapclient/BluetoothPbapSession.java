...
class BluetoothPbapSession implements Callback {
    ...
    private static final String TAG = "LZLB_BluetoothPbapSession";
    ...
    public boolean makeRequest(BluetoothPbapRequest request) {
        Log.e(TAG, "makeRequest: " + request.getClass().getSimpleName());
    ...
    public boolean setAuthResponse(String key) {
        Log.e(TAG, "setAuthResponse key=" + key);
    ...
    private class RfcommConnectThread extends Thread {
        private static final String TAG = "LZLB_RfcommConnectThread";
