...
final class A2dpStateMachine extends StateMachine {
	...
	private static final String TAG ="LZLB_A2dpStateMachine";
    ...
    static A2dpStateMachine make(A2dpService svc, Context context) {
    	Log.e(TAG,"make");
        Log.d("LZLB_A2dpStateMachine", "make");
    ...
    Log.e(TAG,"cleanup");
        ...
        @Override
        public void enter() {
        Log.e(TAG,"Disconnected enter");
            log("Enter Disconnected: " + getCurrentMessage().what);
        }

        @Override
        public boolean processMessage(Message message) {
        	Log.e(TAG,"Disconnected processMessage message:" + message.what);
        ...
        @Override
        public void exit() {
        Log.e(TAG,"Disconnected exit");
            log("Exit Disconnected: " + getCurrentMessage().what);
        }

        // in Disconnected state
        private void processConnectionEvent(int state, BluetoothDevice device) {
        Log.e(TAG,"Disconnected exit state:"+state);
            switch (state) {
    ...
    private class Pending extends State {
        @Override
        public void enter() {
        Log.e(TAG,"Pending enter");
            log("Enter Pending: " + getCurrentMessage().what);
        }

        @Override
        public boolean processMessage(Message message) {
        	Log.e(TAG,"Pending processMessage message:" + message.what);
        ...
        // in Pending state
        private void processConnectionEvent(int state, BluetoothDevice device) {
        Log.e(TAG,"Pending processConnectionEvent state:"+state);
            switch (state) {
                case CONNECTION_STATE_DISCONNECTED:
    ...
    private class Connected extends State {
        ...
        @Override
        public boolean processMessage(Message message) {
        Log.e(TAG,"Connected processMessage message:" + message.what);
        ...
        // in Connected state
        private void processConnectionEvent(int state, BluetoothDevice device) {
        Log.e(TAG,"Connected processConnectionEvent state:"+state);
            switch (state) {
                case CONNECTION_STATE_DISCONNECTED:
                    if (mCurrentDevice.equals(device)) {
    ...
    private class IntentBroadcastHandler extends Handler {
		...
		private static final String TAG ="IntentBroadcastHandler";
