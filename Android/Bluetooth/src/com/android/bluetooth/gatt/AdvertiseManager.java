...
class AdvertiseManager {
    ...
    private static final String TAG = "LZLB_AdvertiseManager";
    ...
    private class ClientHandler extends Handler {
        ...
        private void handleStartAdvertising(AdvertiseClient client) {
        	Log.e(TAG,"handleStartAdvertising");	
        ...
        Log.e(TAG,"handleStopAdvertising");
            Utils.enforceAdminPermission(mService);
            if (client == null) {
                return;
            }
        ...
        int maxAdvertiseInstances() {
        	Log.e(TAG,"maxAdvertiseInstances");
    ...
    private class AdvertiseNative {
		...
		private static final String TAG ="LZLB_AdvertiseNative";
        ...
        Log.e(TAG,"startSingleAdvertising");
        ...
        Log.e(TAG,"getTxPowerLevel settingsTxPowerLevel:"+settings.getTxPowerLevel());
        ...
        Log.e(TAG,"getAdvertisingEventType");
        ...
        Log.e(TAG,"getAdvertisingIntervalUnit :"+settings.getMode());
