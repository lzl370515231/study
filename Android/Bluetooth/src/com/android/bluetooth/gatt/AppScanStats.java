...
/*package*/ class AppScanStats {
    ...
    long stopTime = 0;
    int results = 0;
	private static final String TAG="LZLB_AppScanStats";
    ...
    synchronized boolean isScanningTooFrequently() {
    	Log.e(TAG,"isScanningTooFrequently");
        if (lastScans.size() < NUM_SCAN_DURATIONS_KEPT) {
            return false;
        }
