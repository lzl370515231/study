...
public class GattService extends ProfileService {
    ...
    private static final String TAG = "LZLB_GattService";
    ...
    private ServiceDeclaration getActiveDeclaration() {
    	Log.e(TAG,"getActiveDeclaration");
        synchronized (mServiceDeclarations) {
    ...
    private ServiceDeclaration getPendingDeclaration() {
    	Log.e(TAG,"getPendingDeclaration");
        synchronized (mServiceDeclarations) {
            if (mServiceDeclarations.size() > 0)
    ...
    private void removePendingDeclaration() {
    	Log.e(TAG,"removePendingDeclaration");
        synchronized (mServiceDeclarations) {
            if (mServiceDeclarations.size() > 0)
    ...
    class ClientDeathRecipient implements IBinder.DeathRecipient {
        int mAppIf;
		private static final String TAG="LZLB_ClientDeathRecipient";
    ...
    class ServerDeathRecipient implements IBinder.DeathRecipient {
        int mAppIf;
		private static final String TAG ="LZLB_ServerDeathRecipient";
    ...
    private static class BluetoothGattBinder extends IBluetoothGatt.Stub implements IProfileServiceBinder {
		...
		private static final String TAG="LZLB_BluetoothGattBinder";
        ...
        Log.e(TAG,"flushPendingBatchResults");
            GattService service = getService();
            if (service == null) return;
        ...
        Log.e(TAG,"registerForNotification");
            GattService service = getService();
            if (service == null) return;
        ...
        public void connectionParameterUpdate(int clientIf, String address,
                                              ...
                                              Log.e(TAG,"connectionParameterUpdate");
            GattService service = getService();
            if (service == null) return;
        ...
        public void beginServiceDeclaration(int serverIf, int srvcType,
                                            ...
                                            Log.e(TAG,"beginServiceDeclaration");
            GattService service = getService();
            if (service == null) return;
        ...
        Log.e(TAG,"endServiceDeclaration");
            GattService service = getService();
            if (service == null) return;
        ...
        public void startMultiAdvertising(int clientIf, AdvertiseData advertiseData,
                ...
                Log.e(TAG,"startMultiAdvertising");
            GattService service = getService();
            if (service == null) return;
        ...
        Log.e(TAG,"stopMultiAdvertising");
            GattService service = getService();
            if (service == null) return;
        ...
        Log.e(TAG,"numHwTrackFiltersAvailable");
            GattService service = getService();
    ...
    Log.e(TAG,"hasScanResultPermission");
    ...
    Log.e(TAG,"onRegisterForNotifications");
        String address = mClientMap.addressByConnId(connId);
    ...
    Log.e(TAG,"onReadCharacteristic");
        String address = mClientMap.addressByConnId(connId);
    ...
    void onWriteCharacteristic(int connId, int status, int handle)
            throws RemoteException {
            Log.e(TAG,"onWriteCharacteristic");
        String address = mClientMap.addressByConnId(connId);
    ...
    Log.e(TAG,"onScanFilterEnableDisabled");
        if (DBG) {
    ...
    Log.e(TAG,"onScanFilterParamsConfigured");
        if (DBG) {
    ...
    Log.e(TAG,"onBatchScanStorageConfigured");
        if (DBG) {
    ...
    Log.e(TAG,"onBatchScanStartStopped");
        if (DBG) {
    ...
    private Set<ScanResult> parseBatchScanResults(int numRecords, int reportType,
            byte[] batchRecord) {
            Log.e(TAG,"parseBatchScanResults");
        if (numRecords == 0) {
    ...
    Log.e(TAG,"parseTruncatedResults");
    ...
    Log.e(TAG,"onBatchScanThresholdCrossed");
        if (DBG) {
    ...
    AdvtFilterOnFoundOnLostInfo CreateonTrackAdvFoundLostObject(int client_if, int adv_pkt_len,
                    ...
                    int time_stamp) {
                    Log.e(TAG,"CreateonTrackAdvFoundLostObject");
    ...
    Log.e(TAG,"onScanParamSetupCompleted");
        ClientMap.App app = mClientMap.getById(clientIf);
        if (app == null || app.callback == null) {
    ...
    void onMultipleAdvertiseCallback(int clientIf, int status, boolean isStart,
            ...
            Log.e(TAG,"onMultipleAdvertiseCallback");
        ClientMap.App app = mClientMap.getById(clientIf);
        if (app == null || app.callback == null) {
            Log.e(TAG, "Advertise app or callback is null");
            return;
    ...
    Log.e(TAG,"onScanManagerErrorCallback");
        ClientMap.App app = mClientMap.getById(clientIf);
        if (app == null || app.callback == null) {
            Log.e(TAG, "App or callback is null");
            return;
    ...
    Log.e(TAG,"onAdvertiseInstanceEnabled");
    ...
    Log.e(TAG,"onAdvertiseDataUpdated");
    ...
    Log.e(TAG,"onAdvertiseInstanceDisabled");
    ...
    synchronized List<ParcelUuid> getRegisteredServiceUuids() {
    	Log.e(TAG,"getRegisteredServiceUuids");
    ...
    void onIncludedServiceAdded(int status, int serverIf, int srvcHandle,
                                ...
                                Log.e(TAG,"onIncludedServiceAdded");
    ...
    void onCharacteristicAdded(int status, int serverIf,
                               ...
                               throws RemoteException {
                               Log.e(TAG,"onCharacteristicAdded");
    ...
    void onResponseSendCompleted(int status, int attrHandle) {
     Log.e(TAG,"onResponseSendCompleted");
    ...
    Log.e(TAG,"needsPrivilegedPermissionForScan");
    ...
    private void enforcePrivilegedPermission() {
    	Log.e(TAG,"enforcePrivilegedPermission");
    ...
    Log.e(TAG,"continueServiceDeclaration");
