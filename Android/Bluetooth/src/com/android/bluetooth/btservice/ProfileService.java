...
public abstract class ProfileService extends Service {
    ...
    private static final String TAG = "LZLB_ProfileService";
    ...
    Log.e(TAG,"notifyProfileServiceStateChanged");
    ...
    public void notifyProfileConnectionStateChanged(BluetoothDevice device,
            int profileId, int newState, int prevState) {
            	Log.e(TAG,"notifyProfileConnectionStateChanged");
        AdapterService adapterService = AdapterService.getAdapterService();
        if (adapterService != null) {
