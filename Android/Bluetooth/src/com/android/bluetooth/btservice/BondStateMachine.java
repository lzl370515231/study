...
final class BondStateMachine extends StateMachine {
    ...
    private static final String TAG = "LZLB_BondStateMachine";
    ...
    private class StableState extends State {
    	private static final String TAG ="LZLB_StableState";
        @Override
        public void enter() {
    ...
    Log.e(TAG,"sendDisplayPinIntent");
        Intent intent = new Intent(BluetoothDevice.ACTION_PAIRING_REQUEST);
    ...
    private void clearProfilePriority(BluetoothDevice device) {
    	Log.e(TAG,"clearProfilePriority");
    ...
    private int getUnbondReasonFromHALCode (int reason) {
    	Log.e(TAG,"getUnbondReasonFromHALCode reason:"+reason);
