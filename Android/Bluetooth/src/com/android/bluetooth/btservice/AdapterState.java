...
final class AdapterState extends StateMachine {
    ...
    private static final String TAG = "LZLB_AdapterState";
    ...
    private class OffState extends State {
    	private static final String TAG ="LZLB_OffState";
        @Override
        public void enter() {
        ...
        public boolean processMessage(Message msg) {
			...
			Log.e(TAG,"processMessage msg.what:"+msg.what);
    ...
    private class BleOnState extends State {
    	private static final String TAG ="LZLB_BleOnState";
        @Override
        public void enter() {
        ...
        public boolean processMessage(Message msg) {
			...
			Log.e(TAG,"processMessage MSGWHAT:"+msg.what);
    ...
    private class OnState extends State {
    	private static final String TAG ="LZLB_OnState";
        @Override
        public void enter() {
    ...
    private class PendingCommandState extends State {
		...
		private static final String TAG="LZLB_PendingCommandState";
    ...
    private void notifyAdapterStateChange(int newState) {
    	Log.e(TAG,"notifyAdapterStateChange");
        AdapterService adapterService = mAdapterService;
        AdapterProperties adapterProperties = mAdapterProperties;
        if ((adapterService == null) || (adapterProperties == null)) {
    ...
    void stateChangeCallback(int status) {
    	Log.e(TAG,"stateChangeCallback status:"+status);
