...
public class BluetoothTetheringNetworkFactory extends NetworkFactory {
    ...
    private static final String TAG = "LZLB_BluetoothTetheringNetworkFactory";
    ...
    public BluetoothTetheringNetworkFactory(Context context, Looper looper, PanService panService) {
		...
		Log.e(TAG,"BluetoothTetheringNetworkFactory");
        mContext = context;
    ...
    private void initNetworkCapabilities() {
    	Log.e(TAG,"initNetworkCapabilities");
