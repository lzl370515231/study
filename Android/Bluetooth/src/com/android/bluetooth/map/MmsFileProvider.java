...
public class MmsFileProvider extends ContentProvider {
    static final String TAG = "LZLB_BluetoothMmsFileProvider";
    ...
    public class PipeWriter implements PipeDataWriter<Cursor> {
    	private static final String TAG ="LZLB_PipeWriter";
        /**
        ...
        public void writeDataToPipe(ParcelFileDescriptor output, Uri uri, String mimeType,
            ...
            if (BluetoothMapService.DEBUG) Log.e(TAG, "writeDataToPipe(): uri=" + uri.toString() +
