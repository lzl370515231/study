...
public class BluetoothMapUtils {
    ...
    private static final String TAG = "LZLB_BluetoothMapUtils";
    ...
    public static String getMapHandle(long cpHandle, TYPE messageType){
    	Log.e(TAG,"getMapHandle messageType:"+messageType);
        String mapHandle = "-1";
    ...
    public static String getMapConvoHandle(long cpHandle, TYPE messageType){
    	Log.e(TAG,"getMapConvoHandle messageType:"+messageType);
        String mapHandle = "-1";
        switch(messageType)
        {
            case MMS:
    ...
    {
    	Log.e(TAG,"getCpHandle mapHandle:"+mapHandle);
    ...
    static public TYPE getMsgTypeFromHandle(String mapHandle) {
    	Log.e(TAG,"getMsgTypeFromHandle mapHandle:"+mapHandle);
        long cpHandle = getMsgHandleAsLong(mapHandle);
    ...
    static public String stripInvalidChars(String text) {
    	Log.e(TAG,"stripInvalidChars text:"+text);
        if(text == null) {
            return "";
        }
    ...
    static public byte[] truncateUtf8StringToBytearray(String utf8String, int maxLength)
            throws UnsupportedEncodingException {
            Log.e(TAG,"truncateUtf8StringToBytearray utf8String:"+utf8String+"--maxLength:"+maxLength);
    ...
    public static byte[] quotedPrintableToUtf8(String text, String charset) {
    	Log.e(TAG,"quotedPrintableToUtf8 ");
    ...
    public static final String encodeQuotedPrintable(byte[] bytes) {
			Log.e(TAG,"encodeQuotedPrintable ");
        if (bytes == null) {
            return null;
        }
