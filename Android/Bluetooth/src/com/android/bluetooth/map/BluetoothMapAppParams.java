...
public class BluetoothMapAppParams {
    ...
    private static final String TAG = "LZLB_BluetoothMapAppParams";
    ...
    public String getFilterPeriodBeginString() {
    	Log.e(TAG,"getFilterPeriodBeginString");
    ...
    public byte[] getDatabaseIdentifier() {
    	Log.e(TAG,"getDatabaseIdentifier");
    ...
    public byte[] getChatStateConvoIdByteArray() {
    	Log.e(TAG,"getChatStateConvoIdByteArray");
    ...
    public void setFilterUidPresent(int present) {
    	Log.e(TAG,"setFilterUidPresent present:"+present);
