...
public class BluetoothMapAccountLoader {
    private static final String TAG = "LZLB_BluetoothMapAccountLoader";
    ...
    public LinkedHashMap<BluetoothMapAccountItem,
                         ...
                         Log.e(TAG,"parsePackages includeIcon:"+includeIcon);
    ...
    public BluetoothMapAccountItem createAppItem(ResolveInfo rInfo, boolean includeIcon,
            ...
            Log.e(TAG,"createAppItem includeIcon:"+includeIcon);
    ...
    public ArrayList<BluetoothMapAccountItem> parseAccounts(BluetoothMapAccountItem app)  {
    	Log.e(TAG,"parseAccounts ");
        Cursor c = null;
        if(D) Log.e(TAG,"Finding accounts for app "+app.getPackageName());
    ...
    public int getAccountsEnabledCount() {
        if(D)Log.e(TAG,"Enabled Accounts count:"+ mAccountsEnabledCount);
