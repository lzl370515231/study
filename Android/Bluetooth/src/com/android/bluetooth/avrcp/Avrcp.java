...
public final class Avrcp {
    ...
    private static final String TAG = "LZLB_Avrcp";
    ...
    private class MediaControllerListener extends MediaController.Callback {
    	private static final String TAG ="LZLB_MediaControllerListener";
        @Override
        ...
        public void onPlaybackStateChanged(PlaybackState state) {
			Log.e(TAG,"onPlaybackStateChanged changed: " + state.toString());
    ...
    private class MediaSessionChangeListener implements MediaSessionManager.OnActiveSessionsChangedListener {
    	private static final String TAG ="LZLB_MediaSessionChangeListener";
        public MediaSessionChangeListener() {
        }

        @Override
        public void onActiveSessionsChanged(List<MediaController> controllers) {
			Log.e(TAG,"onActiveSessionsChanged");
    ...
    private void updateCurrentMediaController(MediaController controller) {
		Log.e(TAG,"updateCurrentMediaController");
    ...
    private final class AvrcpMessageHandler extends Handler {
    	private static final String TAG ="LZLB_AvrcpMessageHandler";
    ...
    private void updateA2dpAudioState(int state) {
		Log.e(TAG,"updateA2dpAudioState");
    ...
    private void updateTransportControls(int transportControlFlags) {
		Log.e(TAG,"updateTransportControls");
    ...
    class MediaAttributes {
		...
		private static final String TAG ="LZLB_MediaAttributes";


        public MediaAttributes(MediaMetadata data) {
			Log.e(TAG,"MediaAttributes");
            exists = data != null;
            if (!exists)
                return;
        ...
        public String getString(int attrId) {
			Log.e(TAG,"getString attrId:"+attrId);
            if (!exists)
                return new String();
    ...
    private void processRegisterNotification(int eventId, int param) {
		Log.e(TAG,"processRegisterNotification eventId:"+eventId);
        switch (eventId) {
    ...
    private void handlePassthroughCmd(int id, int keyState) {
		Log.e(TAG,"handlePassthroughCmd id:"+id);
        switch (id) {
    ...
    private int convertPlayStateToPlayStatus(PlaybackState state) {
		Log.e(TAG,"convertPlayStateToPlayStatus state.getState():"+state.getState());
    ...
    private boolean isPlayingState(PlaybackState state) {
		Log.e(TAG,"isPlayingState state.getState:"+state.getState());
    ...
    private void sendPlayPosNotificationRsp(boolean requested) {
		Log.e(TAG,"sendPlayPosNotificationRsp requested:"+requested);
    ...
    public boolean isAbsoluteVolumeSupported() {
		Log.e(TAG,"isAbsoluteVolumeSupported");
    ...
    private void blackListCurrentDevice() {
		Log.e(TAG,"blackListCurrentDevice");
    ...
    private int modifyRcFeatureFromBlacklist(int feature, String address) {
		Log.e(TAG,"modifyRcFeatureFromBlacklist");
        SharedPreferences pref = mContext.getSharedPreferences(ABSOLUTE_VOLUME_BLACKLIST,
                Context.MODE_PRIVATE);
